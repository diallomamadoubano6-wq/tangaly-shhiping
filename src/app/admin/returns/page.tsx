      ...
      <div className={styles.cardHeader} style={{display:'flex', justifyContent:'space-between', alignItems:'center'}}>
        ...
        <div style={{display:'flex', gap:12}}>
           <div style={{position:'relative'}}>
             ...
             <input type="text" placeholder="Rechercher (N° Suivi)" style={{padding:'8px 12px 8px 36px', borderRadius:'8px', border:'1px solid #cbd5e1', outline:'none', fontSize:14, width:250}} />
           </div>
        </div>
      </div>
